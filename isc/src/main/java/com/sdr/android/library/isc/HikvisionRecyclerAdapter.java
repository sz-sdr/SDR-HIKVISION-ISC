...
import com.sdr.android.library.isc.entity.Cameras;
...
class HikvisionRecyclerAdapter extends BaseQuickAdapter<HKItemControl, BaseViewHolder> implements Interface.HikIscPlayCallback {
    private HikBaseActivity activity;

    public HikvisionRecyclerAdapter(int layoutResId, @Nullable List<HKItemControl> data, HikBaseActivity activity) {
